  ...
  return (
    <View style={localStyles.Container}>
      <ScrollView contentContainerStyle={localStyles.subContainer}>
        <Text style={localStyles.headerText}>Buy the Subscription.</Text>

        <TouchableOpacity
          onPress={() =>
            requestSubscription(subscribeProductsArray[0].productId)
          }
        ...
        <TouchableOpacity
          onPress={() =>
            requestSubscription(subscribeProductsArray[1].productId)
          }
